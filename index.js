...
const elProduct1 = document.querySelector("#product1")
elProduct1.innerHTML = product1HTML

const product2HTML = `<img class="card-img-top" src=${product2.image} alt="Slepičkabelka">
        <div class="card-body">
          <h2 class="card-title">${product2.name}</h2>
          <p class="card-text">${product2.description}</p>
        </div>
        <button type="button" class="btn btn-lg btn-primary btn-block">Koupit</button>`
const elProduct2 = document.querySelector("#product2")
elProduct2.innerHTML = product2HTML

const product3HTML = `<img class="card-img-top" src=${product3.image} alt="Anatoplavky">
        <div class="card-body">
          <h2 class="card-title">${product3.name}</h2>
          <p class="card-text">${product3.description} </p>
        </div>
        <button type="button" class="btn btn-lg btn-primary btn-block">Koupit</button>`
const elProduct3 = document.querySelector("#product3")
elProduct3.innerHTML = product3HTML
